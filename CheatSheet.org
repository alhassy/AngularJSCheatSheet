...
<html ng-app> <!-- ⟨0⟩ AngularJS is active for the entire tree -->
  ...
  <body>
    <div>
      ...
      <hr>
      <!-- ⟨3⟩ Actually use the “yourName” value here, *whenever* it is updated! -->
...
[[https://angular-templates.io/tutorials/about/learn-angular-from-scratch-step-by-step#building-an-angular-crud-example-project-step-by-step][“Angular”]] (components focused) in an effort to simplify it.
...
code]{currency} filter displays a number with a “$” symbol and the right number
...
(with-temp-buffer
    ...
    ,*The listing sheet, as PDF, can be found
     ...
     ---there is also a
     badge:beautiful|HTML_webpage|success|https://alhassy.github.io/AngularJSCheatSheet|javascript (•̀ᴗ•́)و
...
<!doctype html>
<html ng-app="phonecatApp"> <!-- [0⟩ AngularJS is active for the entire tree -->
  <head>
    <!-- [1⟩ Actually load AngularJS -->
    <script src="https://ajax.googleapis.com/ajax/libs/angularjs/1.8.2/angular.min.js"></script>
...
ns.my_func = function () { return 3; }
   ...
   5. String MetaProgramming: In JS, if ~f~ is a function then ~f.toString()~ is
      ...
      Names starting with ‘$’ are recognised as /services/.
